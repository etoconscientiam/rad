...
export type OrderDraft = {
  ...
  locale: Locale;
  /**
   * Итог, который клиент показал человеку. Сервер считает свой и сверяет:
   * расхождение — отказ, а не молчаливое согласие. Пайплайн M3.
   * Поле необязательное: заявка без него проходит, проверять нечего.
   */
  quotedTotal?: number;
};
